...
This is tested on a really shitty CPU with WSL enabled... a terrible platform to test this...
I will test on a better CPU backend with more # of trials in the future.